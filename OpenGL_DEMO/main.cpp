...
//Indices for square vertices order
GLuint indices[] =
{
...
int main()
{
	...
	// Links VBO to VAO, identifies the locations of each set of attributes for the shader prog.
	...
	//Use texture class to texture a square with popcat
	Texture popcat("popcat.png", GL_TEXTURE_2D, GL_TEXTURE0, GL_RGBA, GL_UNSIGNED_BYTE);
	
	//get texture unit from shader program
	popcat.texUnit(shaderProgram, "tex0", 0);

	float scaleVal = 0.1f, scaler = 0.0f;
